...
namespace EditorEX.SDK.Factories
{
    public class ClickableTextFactory
    {
        ...
        public EditorClickableText Create(
            Transform parent,
            string text,
            float fontSize,
        ...
        {
            var clickableText = _textFactory.Create<EditorClickableText>(
                parent,
                text,
                fontSize,
                "None"
            ...
            var selectableStateController =
                _instantiator.InstantiateComponent<NoTransitionClickableTextSelectableStateController>(
                    clickableText.gameObject
                );
