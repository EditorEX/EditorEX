...
namespace EditorEX.SDK.Factories
{
    ...
    public class ScrollViewFactory
    {
        ...
        {
            var scrollView = _container
                .InstantiatePrefab(_prefabCollector.GetScrollViewPrefab())
            ...
            scrollView.contentTransform.gameObject.AddComponent<ContentSizeFitter>().verticalFit =
                ContentSizeFitter.FitMode.PreferredSize;

            var scrollViewContent =
                scrollView.contentTransform.gameObject.AddComponent<EditorScrollViewContent>();
