...
namespace EditorEX.SDK.Factories
{
    public class ClickableImageFactory
    {
        ...
        public EditorNativeClickableImage Create(
            Transform parent,
            string location,
        ...
        {
            var clickableImage = _imageFactory.Create<EditorNativeClickableImage>(
                parent,
                location,
                layoutData
            );
            ...
            var selectableStateController =
                _instantiator.InstantiateComponent<NoTransitionClickableImageSelectableStateController>(
                    clickableImage.gameObject
                );
            ...
            transition._transition = _transitionCollector.GetTransition<ColorTransitionSO>(
