...
namespace EditorEX.MapData.SaveDataLoaders
{
    public class V2BeatmapBpmDataVersionedLoader
    {
        ...
        {
            if (
                BeatmapProjectFileHelper.GetVersionedJSONVersion(projectPath, "BPMInfo.dat")
                == _version100
            )
            {
        ...
        {
            BpmInfoSerializedDataV2 bpmSerializedData =
                BeatmapProjectFileHelper.LoadBeatmapJsonObject<BpmInfoSerializedDataV2>(
                    projectPath,
                    "BPMInfo.dat"
                );
            if (bpmSerializedData != null)
            {
                int startOffset = AudioTimeHelper.SecondsToSamples(
                    ...
                    bpmSerializedData.songFrequency
                );
                BpmData bpmData = new BpmData(
                    ...
                    bpmSerializedData
                        .regions.Select(
                            (BpmInfoSerializedDataV2.BpmRegionSerializedData region) =>
                                new BpmRegion(
                                    region.startSampleIndex,
                                    region.endSampleIndex,
                                    region.startBeat,
                                    region.endBeat,
                                    bpmSerializedData.songFrequency
                                )
        ...
        {
            BpmInfoSerializedDataV1 bpmSerializedData =
                BeatmapProjectFileHelper.LoadBeatmapJsonObject<BpmInfoSerializedDataV1>(
                    projectPath,
                    "BPMInfo.dat"
                );
            if (bpmSerializedData != null)
            {
                ...
                BpmData bpmData = new BpmData(
                    ...
                    bpmSerializedData
                        .regions.Select(
                            (BpmInfoSerializedDataV1.BpmRegionSerializedData region) =>
                                new BpmRegion(
                                    region.startSampleIndex,
                                    region.endSampleIndex,
                                    region.startBeat,
