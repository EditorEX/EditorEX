...
namespace EditorEX.MapData.LevelDataSavers
{
    public static class V3Converters
    {
        ...
        public static V3.SliderData CreateSliderSaveData(
            ArcEditorData a,
            ICustomDataRepository customDataRepository
        )
        {
        ...
        public static ColorNoteData CreateColorNoteSaveData(
            NoteEditorData n,
            ICustomDataRepository customDataRepository
        )
        {
        ...
        public static BombNoteData CreateBombNoteSaveData(
            NoteEditorData n,
            ICustomDataRepository customDataRepository
        )
        {
            return SaveCustom(n, customDataRepository)
                ? new V3CustomSaveData.BombNoteSaveData(
                    n.beat,
                    n.column,
                    n.row,
                    n.GetCustomData(customDataRepository)
        ...
        public static BasicEventData CreateBasicEventSaveData(
        ...
        public static V3.ObstacleData CreateObstacleSaveData(
            ObstacleEditorData o,
            ICustomDataRepository customDataRepository
        )
        {
            return SaveCustom(o, customDataRepository)
        ...
        public static V3.WaypointData CreateWaypointSaveData(
        ...
        public static ColorNoteData CreateColorNoteSaveDataFromChains(
            ChainEditorData c,
            ICustomDataRepository customDataRepository
        )
        {
            return SaveCustom(c, customDataRepository)
                ? new V3CustomSaveData.ColorNoteSaveData(
                    c.beat,
                    c.column,
                    c.row,
                    ...
                    0,
                    c.GetCustomData(customDataRepository)
                )
                : new ColorNoteData(
                    c.beat,
                    c.column,
        ...
        public static BurstSliderData CreateBurstSliderSaveData(
            ChainEditorData c,
            ICustomDataRepository customDataRepository
        )
        {
        ...
        public static RotationEventData CreateRotationEventSaveData(
            BasicEventEditorData e,
            ICustomDataRepository customDataRepository
        )
        {
        ...
        public static ColorBoostEventData CreateColorBoostSaveEventData(
            BasicEventEditorData e,
            ICustomDataRepository customDataRepository
        )
        {
            return SaveCustom(e, customDataRepository)
                ? new V3CustomSaveData.ColorBoostEventSaveData(
                    e.beat,
                    e.value == 1,
                    e.GetCustomData(customDataRepository)
                )
        ...
        public static List<EventBoxGroup> CreateEventBoxGroupSaveDataWithFxCollection(
        ...
        public static BasicEventTypesWithKeywords.BasicEventTypesForKeyword CreateBasicEventTypesForKeywordSaveData(
        ...
        public static CombinedEventBoxGroup SplitEventBoxGroupsSaveData(
            (
                List<LightColorEventBoxGroup> colors,
                List<LightRotationEventBoxGroup> rotations,
                List<LightTranslationEventBoxGroup> translations,
        ...
        public static V3CustomSaveData.CustomEventSaveData CreateCustomEventSaveData(
            CustomEventEditorData data
        )
        {
