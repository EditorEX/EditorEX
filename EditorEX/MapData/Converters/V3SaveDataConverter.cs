...
namespace EditorEX.MapData.Converters
{
    ...
    {
        public static Version3CustomBeatmapSaveData ConvertToV3(
            CustomData beatmapData,
            Version2_6_0AndEarlierCustomBeatmapSaveData oldSaveData
        )
        {
            ILookup<bool, v2CustomNoteSaveData> lookup = oldSaveData
                .notes.OrderBy((v2NoteSaveData n) => n)
                .Select(x => (v2CustomNoteSaveData)x)
                .ToLookup(
                    (v2CustomNoteSaveData n) =>
                        n.type == BeatmapSaveDataVersion2_6_0AndEarlier.NoteType.Bomb
                );

            List<v3NoteSaveData> colorNotes = lookup[false]
                .Select(
                    (v2CustomNoteSaveData n) =>
                        new v3CustomNoteSaveData(
                            n.time,
                            n.lineIndex,
                            (int)n.lineLayer,
                            (n.type == BeatmapSaveDataVersion2_6_0AndEarlier.NoteType.NoteA)
                                ? NoteColorType.ColorA
                                : NoteColorType.ColorB,
                            n.cutDirection,
                            0,
                            n.customData
                        )
            ...
            List<v3ObstacleSaveData> obstacles = oldSaveData
                .obstacles.Cast<v2CustomObstacleSaveData>()
                .OrderBy((v2CustomObstacleSaveData n) => n)
                .Select(
                    (v2CustomObstacleSaveData n) =>
                        new v3CustomObstacleSaveData(
                            n.time,
                            n.lineIndex,
            ...
            List<v3SliderSaveData> sliders = oldSaveData
                .sliders.Cast<v2CustomSliderSaveData>()
                .OrderBy((v2CustomSliderSaveData n) => n)
                .Select(
                    (v2CustomSliderSaveData n) =>
                        new v3CustomSliderSaveData(
                            (n.colorType == BeatmapSaveDataVersion2_6_0AndEarlier.ColorType.ColorA)
                                ? NoteColorType.ColorA
                                : NoteColorType.ColorB,
                            n.time,
                            n.headLineIndex,
            ...
            List<v3WaypointSaveData> waypoints = oldSaveData
                .waypoints.Cast<v2CustomWaypointSaveData>()
                .OrderBy((v2CustomWaypointSaveData n) => n)
                .Select(
                    (v2CustomWaypointSaveData n) =>
                        new v3CustomWaypointSaveData(
                            n.time,
                            n.lineIndex,
                            (int)n.lineLayer,
                            n.offsetDirection,
            ...
            ILookup<int, v2CustomEventSaveData> eventsSplit = oldSaveData
                .events.Cast<v2CustomEventSaveData>()
            ...
            List<ColorBoostEventData> colorBoosts = eventsSplit[0]
                .Select(n => new Version3CustomBeatmapSaveData.ColorBoostEventSaveData(
                    n.time,
                    n.value == 1,
                    n.customData
                ))
            ...
            List<RotationEventData> rotationEvents = eventsSplit[1]
            ...
            List<BpmChangeEventData> bpmChanges = eventsSplit[2]
                .Select(n => new Version3CustomBeatmapSaveData.BpmChangeEventSaveData(
                    n.time,
                    n.floatValue,
                    n.customData
                ))
            ...
            List<BasicEventData> basicEvents = eventsSplit[3]
                .Select(n => new v3CustomEventSaveData(
                    n.time,
                    n.type,
                    n.value,
                    n.floatValue,
            ...
            BasicEventTypesWithKeywords basicEventTypesWithKeywords = new(
                oldSaveData
                    .specialEventsKeywordFilters.keywords.Select(
                        n => new BasicEventTypesWithKeywords.BasicEventTypesForKeyword(
                            n.keyword,
                            n.specialEvents
                        )
                    )
            ...
            // custom events
            List<Version3CustomBeatmapSaveData.CustomEventSaveData> customEvents = oldSaveData
                .customEvents.Select(n => new Version3CustomBeatmapSaveData.CustomEventSaveData(
                    n.time,
                    n.type,
                    n.customData
                ))
