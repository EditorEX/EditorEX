...
namespace EditorEX.Chroma.Patches
{
    ...
    {
        private static readonly MethodInfo _oldConvert = AccessTools.Method(
            typeof(BeatmapBasicEventConverter),
            "ConvertBasicEvent"
        );
        private static readonly MethodInfo _newConvert = AccessTools.Method(
            typeof(InjectCustomDataIntoLivePreview),
            "ConvertBasicEvent"
        );
        ...
        BeatmapEventData ConvertBasicEvent(BasicEventEditorData? e)
        {
            ...
            {
                result = new CustomBasicBeatmapEventData(
                    e.beat,
                    e.type,
                    e.value,
                    e.floatValue,
        ...
        [AffinityPatch(
            typeof(BeatmapBasicEventConverter),
            nameof(BeatmapBasicEventConverter.ConvertBasicEvent)
        )]
        [AffinityPrefix]
        ...
        private static readonly Dictionary<
            ...
            CustomBasicBeatmapEventData
        > _defaultsForTypeCustom = new();
        ...
        public bool Prefix2(BasicBeatmapEventData __instance, ref BeatmapEventData __result)
        {
            if (__instance is CustomBasicBeatmapEventData customBasicBeatmapEventData)
            {
                ...
                if (
                    _defaultsForTypeCustom.TryGetValue(
                        __instance.basicBeatmapEventType,
                        out basicBeatmapEventData
                    )
                )
                {
                ...
                __result = _defaultsForTypeCustom[__instance.basicBeatmapEventType] =
                    new CustomBasicBeatmapEventData(
                        ...
                        0f,
                        new CustomData(),
                        customBasicBeatmapEventData.version
                    );
                return false;
            }
            return true;
