...
public static class V3Converters
{
    ...
    {
        return SaveCustom(n)
            ? new V3CustomSaveData.BombNoteSaveData(n.beat, n.column, n.row, n.GetCustomData())
    ...
    {
        return SaveCustom(e)
            ? new V3CustomSaveData.ColorBoostEventSaveData(e.beat, e.value == 1, e.GetCustomData())
                            ...
                            .Select(
                                delegate (FxEventBoxEditorData eventBox)
                                {
                                    ...
                                    DistributionParamType vfxDistributionParamType =
                                        (DistributionParamType)eventBox.vfxDistributionParamType;
