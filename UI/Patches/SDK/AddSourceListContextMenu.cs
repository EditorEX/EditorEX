...
namespace EditorEX.UI.Patches.SDK
{
    ...
    internal class AddSourceListContextMenu : IAffinity
    {
        ...
        private AddSourceListContextMenu(IInstantiator instantiator)
        {
            _instantiator = instantiator;
        }

        [AffinityPatch(
            typeof(TextSegmentedControl),
            nameof(TextSegmentedControl.CellForCellNumber)
        )]
        [AffinityPostfix]
        private void SetData(
            TextSegmentedControl __instance,
            int cellNumber,
            SegmentedControlCell __result
        )
        {
            ...
            SourceListContextMenu contextMenu =
                __result.gameObject.GetComponent<SourceListContextMenu>();
            ...
            {
                contextMenu = _instantiator.InstantiateComponent<SourceListContextMenu>(
                    __result.gameObject
                );
            }
